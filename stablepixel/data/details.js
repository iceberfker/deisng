// FOR EDITING
    ...
    const serverName = "Non-Fungible Fungi";
    const serverDescription = "A 10K collection of unique 3D animated Mushrooms strolling across the Ethereum blockchain.";
    const serverWebsite = "https://talesoftheunderlog.xyz/"; // include https://
    const serverTwitter = "https://x.com/FungibleFungi"; // include https://
    const serverDiscord = "https://discord.gg/stablepixel"; // include https://
    const serverChain = "ethereum";
    // serverChain choices = abstract, apechain, arbitrum, avax, base, berachain, blast, bsc, ethereum, flow, monad, optimism, polygon, ronin, sei, shape, solana, soneium, unichain, zora
    const explorerLink = "https://etherscan.io/token/0x90ee3cf59fcde2fe11838b9075ea4681462362f1";
    const gifImages = [
   "https://pbs.twimg.com/profile_images/1590633844515954688/TXignsp6_400x400.png",
